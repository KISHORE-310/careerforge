...
jobsRouter.get("/", optionalAuth, async (req: Request, res: Response) => {
  try {
    ...
    company_logo: null,
        ...
        source: j.source,
        source_name: j.externalId?.startsWith("adzuna:") ? "Adzuna" : j.externalId?.startsWith("remotive:") ? "Remotive" : "CareerForge catalog",
  ...
  try {
    ...
    res.json({
      ...
      job: {
        ...
        source: job.source,
        source_name: job.externalId?.startsWith("adzuna:") ? "Adzuna" : job.externalId?.startsWith("remotive:") ? "Remotive" : "CareerForge catalog",
